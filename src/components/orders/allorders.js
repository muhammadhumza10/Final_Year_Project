...
const AllOrders = ({ user, logout, orders,setRefreshToken }) => {
  ...
  const recordsafterpaging = () => {
    return searchFilter(orders).slice(
      page * rowsPerPage,
      (page + 1) * rowsPerPage
    );
  };
    ...
    <>
      ...
      <div className="mt-5">
                        ...
                        <a>
                          <Tooltip title="View Order">
                            <div
                              ...
                              className="w-7 h-7 bg-green-100 flex items-center justify-center rounded-full"
                            >
                              <IconButton
                                sx={{ color: "rgb(34, 154, 22)" }}
                                size="small"
        ...
        <TablePagination
          ...
          component="div"
          count={Object.keys(searchFilter(orders)).length}
