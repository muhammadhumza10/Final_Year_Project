      ...
      <StyledWrap>
        <Container component={MotionViewport} sx={{ position: 'relative' }}>
          <Grid container>
            ...
            <Grid item md={6}>
              <StyledContent src="/assets/images/home/forshopowner.jpg" variants={varFade().in} />
            </Grid>
          </Grid>
        </Container>
  ...
  return (
    <StyledDescription>
      ...
      <m.div variants={varFade().inUp}>
        <Typography
          ...
          sx={{
            ...
            mb: 5,
            ...textGradient(
              `300deg, ${theme.palette.success.main} 0%, ${theme.palette.warning.main} 100%`
            ),
      ...
      <Typography
        ...
        >
          Our platform has a wide variety of fabrics spreading through a vast range of categories. Shop owners can analyze and buy quality fabrics from a wide range of sellers and industrial manufacturers registered on our platform.
        </Typography>
      </m.div>
    </StyledDescription>
  );
      ...
      sx={{
        ...
        ...filterStyles(
          `drop-shadow(320px 20px 80px ${
            isLight ? alpha(theme.palette.grey[900], 0.7) : theme.palette.common.black
          })`
        ),
        ...(anchor === 'bottom' && {
          zIndex: 9,
